...
window.EXPORT_URL = window.EXPORT_URL || window.DATA + '/export';
window.SAVE_URL = window.SAVE_URL || window.DATA + '/save';
window.OPEN_URL = window.OPEN_URL || window.DATA + '/open';
...
window.mxBasePath = window.mxBasePath || '../vendors/mxgraph';
